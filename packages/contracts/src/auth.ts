import { z } from 'zod';
import { BasicResultResponseSchema } from './result';
import { ViewModeSchema } from './session';
...
export const ArchiveDetailResponseSchema = BasicResultResponseSchema.extend({ viewMode: ViewModeSchema });
